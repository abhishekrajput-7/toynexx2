...
(function () {
  ...
  const PRODUCTS = [
    { id: 'p01', name: 'Crimson Sentinel',  category: 'Superhero Icons', price: 6499, oldPrice: 7999, edition: 47,  total: 500, tag: 'New',      desc: 'A vigilant guardian sculpted mid-leap, cast in matte resin with hand-painted crimson accents.' },
    { id: 'p02', name: 'Void Ronin',        category: 'Anime Legends',   price: 5299, oldPrice: null, edition: 112, total: 800, tag: null,        desc: 'A lone blade-wielder frozen in a decisive stance, finished with a weathered steel palette.' },
    { id: 'p03', name: 'Iron Marshal',      category: 'Superhero Icons', price: 8999, oldPrice: null, edition: 9,   total: 250, tag: 'Bestseller',desc: 'Heavy-plated armor sculpt with articulated joints and illuminated chest core detailing.' },
    { id: 'p04', name: 'Solar Guardian',    category: 'Anime Legends',   price: 4799, oldPrice: 5499, edition: 233, total: 1000,tag: 'Sale',      desc: 'Radiant energy aura base included. A fan-favorite pose recreated in premium PVC.' },
    { id: 'p05', name: 'Titan Breaker MK-7',category: 'Mecha Series',    price: 11999,oldPrice: null, edition: 3,   total: 150, tag: 'Limited',   desc: 'Full diecast mecha frame with swappable weapon arms and LED eye module.' },
    { id: 'p06', name: 'Shadow Ninetails',  category: 'Anime Legends',   price: 5999, oldPrice: null, edition: 66,  total: 600, tag: null,        desc: 'Nine-tail sculpt with translucent resin effects, mounted on a lacquered display base.' },
    { id: 'p07', name: 'Thunder Fist',      category: 'Superhero Icons', price: 7299, oldPrice: null, edition: 21,  total: 400, tag: null,        desc: 'Dynamic impact pose capturing peak kinetic energy, finished in a satin-matte coat.' },
    { id: 'p08', name: 'Phantom Blade',     category: 'Limited Edition', price: 13499,oldPrice: 15999,edition: 2,   total: 100, tag: 'Vault',     desc: 'Vault-exclusive sculpt with a numbered brass certificate plate and velvet display case.' },
    { id: 'p09', name: 'Storm King',        category: 'Mecha Series',    price: 9499, oldPrice: null, edition: 58,  total: 300, tag: null,        desc: 'Storm-forged armor plating with hand-weathered detailing across every panel.' },
    { id: 'p10', name: 'Neon Reaper',       category: 'Anime Legends',   price: 6299, oldPrice: null, edition: 140, total: 700, tag: 'New',       desc: 'Cel-shaded paint technique brings the signature neon-edge style to life on the shelf.' },
    { id: 'p11', name: 'Ashfall Vanguard',  category: 'Superhero Icons', price: 8299, oldPrice: null, edition: 34,  total: 350, tag: null,        desc: 'Battle-worn cape sculpt with fabric-textured resin finish and dynamic wind physics.' },
    { id: 'p12', name: 'Obsidian Wraith',   category: 'Limited Edition', price: 15999,oldPrice: null, edition: 1,   total: 50,  tag: 'Vault',     desc: 'The rarest cast in the vault line. One-of-fifty, individually hand-signed by the sculptor.' }
  ];
  ...
  document.getElementById('accountBtn').addEventListener('click', () => authOverlay.classList.add('open'));
